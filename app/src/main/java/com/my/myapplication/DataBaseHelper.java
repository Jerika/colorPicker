...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.my.myapplication/databases/";
    private static String DB_NAME = "colors.db";
    ...
    public ArrayList<Colors> getColor(int red, int green, int blue){
        ...
        Cursor cursor = myDataBase.rawQuery("SELECT c.*, ( (c.R-" + red + ")*(c.R-" + red + ") " +
